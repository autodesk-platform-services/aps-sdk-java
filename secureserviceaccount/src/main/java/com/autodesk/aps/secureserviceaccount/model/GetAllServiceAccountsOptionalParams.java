...
package com.autodesk.aps.secureserviceaccount.model;  
 ...
 /**
  * Represents optional parameters for the `getAllServiceAccounts` method.
  * This class uses the Builder pattern to allow flexible construction of objects.
  */
public class GetAllServiceAccountsOptionalParams{
    private String accessToken;

    private GetAllServiceAccountsOptionalParams(Builder builder){
                this.accessToken = builder.accessToken;
    }

    
    /**
     * Builder class for constructing instances of GetAllServiceAccountsOptionalParams.
     */
    public static class Builder {
        ...
        /**
         * Builds and returns an instance of GetAllServiceAccountsOptionalParams.
         * 
         * @return GetAllServiceAccountsOptionalParams object.
         */
        public GetAllServiceAccountsOptionalParams build() {
            return new GetAllServiceAccountsOptionalParams(this);
        }
    }

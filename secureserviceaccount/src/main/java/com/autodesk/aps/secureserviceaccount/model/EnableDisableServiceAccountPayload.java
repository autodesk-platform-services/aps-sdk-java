 ...
 */
@Schema(description = "The request body for enable or disable service account")
@JsonPropertyOrder({
  EnableDisableServiceAccountPayload.JSON_PROPERTY_STATUS
})
@JsonTypeName("enable-disable-service-account-payload")
@JsonIgnoreProperties(ignoreUnknown = true)

public class EnableDisableServiceAccountPayload {
  public static final String JSON_PROPERTY_STATUS = "status";
  private Status status;


  public EnableDisableServiceAccountPayload status(Status status) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    EnableDisableServiceAccountPayload enableDisableServiceAccountPayload = (EnableDisableServiceAccountPayload) o;
    return Objects.equals(this.status, enableDisableServiceAccountPayload.status);
  }
  ...
  public String toString() {
    ...
    sb.append("class EnableDisableServiceAccountPayload {\n");

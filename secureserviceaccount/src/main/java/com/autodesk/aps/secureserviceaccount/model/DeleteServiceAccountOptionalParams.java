...
package com.autodesk.aps.secureserviceaccount.model;  
 ...
 /**
  * Represents optional parameters for the `deleteServiceAccount` method.
  * This class uses the Builder pattern to allow flexible construction of objects.
  */
public class DeleteServiceAccountOptionalParams{
    private String accessToken;

    private DeleteServiceAccountOptionalParams(Builder builder){
                this.accessToken = builder.accessToken;
    }

    
    /**
     * Builder class for constructing instances of DeleteServiceAccountOptionalParams.
     */
    public static class Builder {
        ...
        /**
         * Builds and returns an instance of DeleteServiceAccountOptionalParams.
         * 
         * @return DeleteServiceAccountOptionalParams object.
         */
        public DeleteServiceAccountOptionalParams build() {
            return new DeleteServiceAccountOptionalParams(this);
        }
    }

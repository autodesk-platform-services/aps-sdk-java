...
package com.autodesk.aps.secureserviceaccount.model;  
 ...
 /**
  * Represents optional parameters for the `createServiceAccount` method.
  * This class uses the Builder pattern to allow flexible construction of objects.
  */
public class CreateServiceAccountOptionalParams{
    private String accessToken;

    private CreateServiceAccountOptionalParams(Builder builder){
                this.accessToken = builder.accessToken;
    }

    
    /**
     * Builder class for constructing instances of CreateServiceAccountOptionalParams.
     */
    public static class Builder {
        ...
        /**
         * Builds and returns an instance of CreateServiceAccountOptionalParams.
         * 
         * @return CreateServiceAccountOptionalParams object.
         */
        public CreateServiceAccountOptionalParams build() {
            return new CreateServiceAccountOptionalParams(this);
        }
    }

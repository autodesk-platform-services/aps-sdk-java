...
package com.autodesk.aps.secureserviceaccount.model;  
 ...
 /**
  * Represents optional parameters for the `enableDisableServiceAccountKey` method.
  * This class uses the Builder pattern to allow flexible construction of objects.
  */
public class EnableDisableServiceAccountKeyOptionalParams{
    private String accessToken;

    private EnableDisableServiceAccountKeyOptionalParams(Builder builder){
                this.accessToken = builder.accessToken;
    }

    
    /**
     * Builder class for constructing instances of EnableDisableServiceAccountKeyOptionalParams.
     */
    public static class Builder {
        ...
        /**
         * Builds and returns an instance of EnableDisableServiceAccountKeyOptionalParams.
         * 
         * @return EnableDisableServiceAccountKeyOptionalParams object.
         */
        public EnableDisableServiceAccountKeyOptionalParams build() {
            return new EnableDisableServiceAccountKeyOptionalParams(this);
        }
    }

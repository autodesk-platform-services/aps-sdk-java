...
package com.autodesk.aps.secureserviceaccount.model;  
 ...
 /**
  * Represents optional parameters for the `deleteServiceAccountKey` method.
  * This class uses the Builder pattern to allow flexible construction of objects.
  */
public class DeleteServiceAccountKeyOptionalParams{
    private String accessToken;

    private DeleteServiceAccountKeyOptionalParams(Builder builder){
                this.accessToken = builder.accessToken;
    }

    
    /**
     * Builder class for constructing instances of DeleteServiceAccountKeyOptionalParams.
     */
    public static class Builder {
        ...
        /**
         * Builds and returns an instance of DeleteServiceAccountKeyOptionalParams.
         * 
         * @return DeleteServiceAccountKeyOptionalParams object.
         */
        public DeleteServiceAccountKeyOptionalParams build() {
            return new DeleteServiceAccountKeyOptionalParams(this);
        }
    }

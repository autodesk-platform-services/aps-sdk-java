...
package com.autodesk.aps.secureserviceaccount.model;  
 ...
 /**
  * Represents optional parameters for the `createServiceAccountKey` method.
  * This class uses the Builder pattern to allow flexible construction of objects.
  */
public class CreateServiceAccountKeyOptionalParams{
    private String accessToken;

    private CreateServiceAccountKeyOptionalParams(Builder builder){
                this.accessToken = builder.accessToken;
    }

    
    /**
     * Builder class for constructing instances of CreateServiceAccountKeyOptionalParams.
     */
    public static class Builder {
        ...
        /**
         * Builds and returns an instance of CreateServiceAccountKeyOptionalParams.
         * 
         * @return CreateServiceAccountKeyOptionalParams object.
         */
        public CreateServiceAccountKeyOptionalParams build() {
            return new CreateServiceAccountKeyOptionalParams(this);
        }
    }

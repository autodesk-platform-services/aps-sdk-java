...
package com.autodesk.aps.secureserviceaccount.model;  
 ...
 /**
  * Represents optional parameters for the `getAllServiceAccountKeys` method.
  * This class uses the Builder pattern to allow flexible construction of objects.
  */
public class GetAllServiceAccountKeysOptionalParams{
    private String accessToken;

    private GetAllServiceAccountKeysOptionalParams(Builder builder){
                this.accessToken = builder.accessToken;
    }

    
    /**
     * Builder class for constructing instances of GetAllServiceAccountKeysOptionalParams.
     */
    public static class Builder {
        ...
        /**
         * Builds and returns an instance of GetAllServiceAccountKeysOptionalParams.
         * 
         * @return GetAllServiceAccountKeysOptionalParams object.
         */
        public GetAllServiceAccountKeysOptionalParams build() {
            return new GetAllServiceAccountKeysOptionalParams(this);
        }
    }

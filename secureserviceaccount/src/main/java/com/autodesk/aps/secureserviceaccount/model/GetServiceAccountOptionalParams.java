...
package com.autodesk.aps.secureserviceaccount.model;  
 ...
 /**
  * Represents optional parameters for the `getServiceAccount` method.
  * This class uses the Builder pattern to allow flexible construction of objects.
  */
public class GetServiceAccountOptionalParams{
    private String accessToken;

    private GetServiceAccountOptionalParams(Builder builder){
                this.accessToken = builder.accessToken;
    }

    
    /**
     * Builder class for constructing instances of GetServiceAccountOptionalParams.
     */
    public static class Builder {
        ...
        /**
         * Builds and returns an instance of GetServiceAccountOptionalParams.
         * 
         * @return GetServiceAccountOptionalParams object.
         */
        public GetServiceAccountOptionalParams build() {
            return new GetServiceAccountOptionalParams(this);
        }
    }

...
package com.autodesk.aps.secureserviceaccount.model;  
 ...
 /**
  * Represents optional parameters for the `enableDisableServiceAccount` method.
  * This class uses the Builder pattern to allow flexible construction of objects.
  */
public class EnableDisableServiceAccountOptionalParams{
    private String accessToken;

    private EnableDisableServiceAccountOptionalParams(Builder builder){
                this.accessToken = builder.accessToken;
    }

    
    /**
     * Builder class for constructing instances of EnableDisableServiceAccountOptionalParams.
     */
    public static class Builder {
        ...
        /**
         * Builds and returns an instance of EnableDisableServiceAccountOptionalParams.
         * 
         * @return EnableDisableServiceAccountOptionalParams object.
         */
        public EnableDisableServiceAccountOptionalParams build() {
            return new EnableDisableServiceAccountOptionalParams(this);
        }
    }
